...
function mainMagic(){
	...
	RPGSystem.getMenu().createStatusGroupSelect(250,250,300,500,30,"Magic");
...
function mainStatus(){
	...
	//create the menu to select a character
	RPGSystem.getMenu().createStatusGroupSelect(250,250,300,500,30,"Status");
...
function mainSkill(){
	...
	//create the menu to select a character
	RPGSystem.getMenu().createStatusGroupSelect(250,250,300,500,30,"Skill");
...
function mainEquip(){
	...
	//create the menu to select a character
	RPGSystem.getMenu().createStatusGroupSelect(250,250,300,500,30,"Equip");
