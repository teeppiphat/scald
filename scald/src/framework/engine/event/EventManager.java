				...
				if(RPGSystem.getRPGSystem().getBattleSystem().getActionStrategy().isShowAnimation()){
					...
					if(RPGSystem.getRPGSystem().getBattleSystem().getActionStrategy().getMoment() != null){
						...
						if(group){
							...
							//enemy
							identifier = RPGSystem.getRPGSystem().getBattleSystem().getEnemyGroup()[0].getEnemy(position).getIdentifier();
						...
						//RPGSystem.getRPGSystem().getBattleSystem().getActionStrategy().getMoment().
